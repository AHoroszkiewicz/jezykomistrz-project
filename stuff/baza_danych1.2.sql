...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 21, 2019 at 10:32 PM
...
(2, 'admin', 'admin', 'admin@example.com', 3, 1),
(3, 'user', 'user', 'user@example.com', 1, 1),
(4, 'teacher', 'teacher', 'teacher@example.com', 2, 1),
(5, 'root', 'root', 'root@example.com', 4, 1),
(6, 'blocked', 'blocked', 'blocked@example.com', 1, 3),
(7, 'inactive', 'inactive', 'inactive@example.com', 1, 2),
(8, 'removed', 'removed', 'removed@example.com', 1, 4),
(9, 'login1', 'kaloryfer1', 'login1@example.com', 1, 1),
(10, 'login2', 'kaloryfer1', 'login2@example.com', 1, 1),
(11, 'login3', 'kaloryfer1', 'login3@example.com', 1, 1);
...
--
ALTER TABLE `uprawnienia`
  MODIFY `id_uprawnien` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
